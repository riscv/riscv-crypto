...
Instructions that violate these `vl` or `vstart` constraints will will raise an
...
SEW constraints::
Some Vector Crypto instructions are only defined for a specific `SEW`, all other values reserved.
