...
[NOTE]
====
All instructions in this document shall be executed with data independent execution time. This is, the latency of
instruction execution shall not vary based on the values of the inputs.
====
...
include::./riscv-crypto_vector-inst-table.adoc[]
include::./riscv-crypto_vector-zvkb-inst-table.adoc[]
