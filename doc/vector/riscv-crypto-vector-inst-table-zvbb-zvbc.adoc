...
=== Crypto Vector Bitmanip and Caryless Multiply Instructions

OP-V (0x57)
*Zvbb* and *Zvbc* Vector instructions *in bold*
//[%auto-width]
...
| 110100 | | |I| *vwsll*    | 110100 |V|X| vwaddu.w    | 110100 |V|F| vfwadd.w
