[[insns-vaes256k14, Vector AES-256 Generate round key 14]]
= vaes256k14.vv

Synopsis::
Vector AES-256 Generate round key 14

Mnemonic::
vaes256k14.vv vd, vs1, vs2
...
Description:: 
This instruction generates the final (14th) roundkey for AES-256 for consumption by
