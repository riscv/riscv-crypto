...
The rounds number is stored in the lower 3 bits of the unsigned 5-bit `uimm` immediate. The bits in 
uimm[4:3] are ignored. Round group numbers range from 0 to 7 and indicate which
