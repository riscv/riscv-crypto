...
are read in, although only four of them are consumed. Based on the round group be being processed
(as specified in rnds), the next state of eight 32-bit words is produced and written as an element group.
