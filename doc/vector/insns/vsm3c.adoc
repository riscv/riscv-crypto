...
// load state with swap to little endian
  let {H, G, F, E, D, C, B, A} : bits(256) : bits(256) = brev8(get_velem(vd, 256, i));   // order of elements in register
//load message schedule with swap to little endian
  let {u_w7, u_w6, w5, w4, u_w3, u_w2, w1, w0} : bits(256) = brev8(get_velem(vd, 256, i));
  ...
  let result : bits(256) = {brev8(G1),brev8(G2), brev8(E1), BREV8(E2), BREV8(C1), BREV8(C2), BREV8(A1), BREV8(A2)};
