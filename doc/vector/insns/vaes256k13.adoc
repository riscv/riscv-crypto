[[insns-vaes256k13, Vector AES-256 Generate round key 13]]
= vaes256k13.vv

Synopsis::
Vector AES-256 Generate round key 13

Mnemonic::
vaes256k13.vv vd, vs1, vs2
...
Description:: 
This instruction generates the penultimate (13th) roundkey for AES-256 for consumption by
