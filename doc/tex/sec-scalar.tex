...
RV32, RV64:
    ...
    lut4lo  rd, rs1, rs2      // Variant 3
    lut4hi  rd, rs1, rs2      // Variant 3
\end{cryptoisa}
...
\item Variant 3: Avoid ternary operations completely by splitting it
    into a {\tt lut4lo} and {\tt lut4hi} variant.
\end{itemize}
