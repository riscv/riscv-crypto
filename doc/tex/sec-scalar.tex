...
\question{
These instructions introduce the ``double width writeback" idiom to
RISC-V.
How acceptable is this?
What other instructions could take advantage of this?
...
The \mnemonic{maccu} instruction concatenates source registers
