...
See \cite[Section 2.9.3]{riscv:bitmanip:draft} for details of
these instructions.
...
instructions are only proposed for inclusion on RV32, since RV64
...
see if this technique is a worthy mitigation for removing the 
funnel shifts.}.
