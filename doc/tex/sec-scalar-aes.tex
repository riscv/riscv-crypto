...
\begin{cryptoisa}
saes.v4.sub      rd, rs1        // SubBytes only, for KeySchedule
saes.v4.encsm.lo rd, rs1, rs2   // Encrypt ShiftRows, SubBytes, MixColumns
saes.v4.encsm.hi rd, rs1, rs2   //
saes.v4.encs.lo  rd, rs1, rs2   // Encrypt ShiftRows, SubBytes
saes.v4.encs.hi  rd, rs1, rs2   //

saes.v4.imix     rd, rs1        // InvMixColumns for Decrypt KeySchedule
saes.v4.decsm.lo rd, rs1, rs2   // Decrypt ShiftRows, SubBytes, MixColumns
saes.v4.decsm.hi rd, rs1, rs2   //
saes.v4.decs.lo  rd, rs1, rs2   // Decrypt ShiftRows, SubBytes
...
See the pseudo code in figure \ref{fig:pesudo:aes:v4} to see how this works.
\item
