...
*   **Entropy:** A minimum requirement is that n, n >= 128 bits of "full
    ...
    conservative assumption (see Section 3.1.5.1.2 in <<SP800-90B>>).
...
NOTE:	While we do not require that entropy source implementations are
certified designs, we do expect that they should behave in an compatible
manner do not create undue security risks to users. Self-evaluation and
