...
The FAIL and non-fail conditions may convey additional information in
extended (non-baseline) implementations; for example additional entropy
bits may be available along with indicators of the internal state of the
the generator may be conveyed.
